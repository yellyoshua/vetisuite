...
import PortalsPage from "@/modules/portals/page";
import PortalNewPage from "@/modules/portals/new-page";
import PortalShowPage from "@/modules/portals/show-page";
import PortalEditPage from "@/modules/portals/edit-page";

/* ================================================================
   RUTAS DEL STAFF — el panel interno de la clínica, dentro de su
   cáscara (`CustomLayout`). Las páginas públicas de los portales
   tendrán su propio archivo de rutas cuando se implementen.
================================================================ */
  ...
  return (
    <CustomLayout>
      <Routes>
        ...
        <Route path="/portals">
          <Route index element={<PortalsPage />} />
          <Route path="new" element={<PortalNewPage />} />
          <Route path="show/:id" element={<PortalShowPage />} />
          <Route path="edit/:id" element={<PortalEditPage />} />
        </Route>
