...
import { Btn, DateInput, Input } from "@/components/ui";
      ...
      {overrides.map((override, i) => (
        <div key={i} className="p-3 mb-2" style={{ border: `1px solid ${T.line}`, borderRadius: 12 }}>
          <div className="flex items-center gap-2 flex-wrap mb-2">
            <DateInput style={{ width: 168 }} value={override.date}
              onChange={(e) => patch(i, { ...override, date: e.target.value })} />
            <Input style={{ flex: 1, minWidth: 160 }} placeholder="Motivo (ej: Feriado)" value={override.label}
