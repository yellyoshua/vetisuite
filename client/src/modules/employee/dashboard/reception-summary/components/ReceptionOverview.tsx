import { CalendarDaysIcon, CheckIcon, ClockIcon, TrendingUpIcon } from 'lucide-react'
...
import DailyBarChart from '@/modules/employee/dashboard/components/DailyBarChart'
...
type ReceptionOverviewProps = {
  summary: ReceptionSummary
}

export default function ReceptionOverview({ summary }: ReceptionOverviewProps) {
  return (
    <CustomPage
      title="Recepción"
    ...
    >
      <ReceptionSummaryContent summary={summary} />
    </CustomPage>
  )
}
