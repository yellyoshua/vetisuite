...
import type { ProfileSession } from '@/modules/employee/profile/sessions/sessions.service'
...
export default function Sessions({ sessions, refetch }: SessionsProps) {
  return (
    <CustomPage
      ...
      description="Estos son los dispositivos con la sesión abierta en tu cuenta. Cierra el que no reconozcas."
      goBackPath="/profile"
    >
      {sessions.length === 0
        ? <CustomPageContainer>
